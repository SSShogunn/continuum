...
export default function StatsPage() {
  ...
  useEffect(() => {
    ...
    fetch("/api/stats/activity?limit=5&status=error")
      .then((r) => r.json())
          ...
          <div className="grid grid-cols-1 xl:grid-cols-2 gap-4">
            <section>
              <div className="flex items-center justify-between mb-3">
                ...
                <Link href="/dashboard/activity" className="text-xs text-muted-foreground hover:text-foreground underline underline-offset-2">
                  View all
                </Link>
              </div>
              <Card surface="chrome">
