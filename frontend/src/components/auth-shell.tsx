    ...
    <main className="relative flex min-h-screen items-center justify-center overflow-hidden bg-background px-4 py-16">
      ...
      <div className="relative z-10 w-full max-w-sm">
        ...
        <motion.div
          ...
          className="relative w-full min-w-0 overflow-hidden rounded-[var(--radius)] border border-border bg-card px-7 py-8 sm:px-9 sm:py-10 shadow-[0_1px_0_rgba(255,255,255,0.4)_inset,0_14px_30px_-14px_rgba(0,0,0,0.3)] dark:shadow-[0_1px_0_rgba(255,255,255,0.5)_inset,0_24px_48px_-18px_rgba(0,0,0,0.65)] [&_*]:min-w-0 [&_*]:max-w-full"
        >
          <span
            aria-hidden
          ...
          <Link href="/" className="mb-6 inline-block font-heading text-[1.05rem] font-semibold tracking-tight text-foreground">
            Continuum
          </Link>
